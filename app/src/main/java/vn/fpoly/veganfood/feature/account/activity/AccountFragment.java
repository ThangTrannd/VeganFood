...
import vn.fpoly.veganfood.databinding.FragmentAccountBinding;
import vn.fpoly.veganfood.dialog.DialogUtils;
import vn.fpoly.veganfood.feature.account.fragment.IntroductFragment;
import vn.fpoly.veganfood.feature.account.fragment.ListStoreFragment;
import vn.fpoly.veganfood.feature.account.fragment.RulesFragment;
import vn.fpoly.veganfood.feature.account.fragment.SupportFragment;
import vn.fpoly.veganfood.feature.account.fragment.VersionFragment;
import vn.fpoly.veganfood.feature.account.network.ApiService;
import vn.fpoly.veganfood.feature.login.LoginActivity;
import vn.fpoly.veganfood.model.AccountResult;
import vn.fpoly.veganfood.model.Result;
...
//                                editor.clear().commit();
    ...
    private void checkUserNull() {
        if (getToken().isEmpty()) {
            ...
            binding.tvUpdateInfor.setText("Đăng ký tài khoản và nhận ngay quà tặng hấp dẫn");
