...
import vn.fpoly.veganfood.feature.cart.CartProductAdapter;
...
//    private TranferClickListener tranferClickListener;
    ...
    @Override
    public OrderHorder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.order_item, parent, false);
        return new OrderHorder(view);
    }

    @Override
    public void onBindViewHolder(final OrderHorder holder, final int position) {
